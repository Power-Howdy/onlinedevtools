...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description:
      "Generate realistic placeholder content in 16 languages for UI, website, localization, and app testing. Includes Arabic and Hebrew RTL plus mixed-language mode.",
    category: "Generators",
    seoTitle: "Free Multilingual Placeholder Text Generator – Localization & RTL Testing",
    seoDescription:
      "Generate sample bios, product copy, articles, and UI text in 16 languages. Test localization with Arabic and Hebrew RTL, mixed-language output, exact word counts, and TXT/JSON/CSV export. Not an AI writer or translator.",
    keywords: [
  ...
  },
  {
    ...
    description:
      "Preview Facebook, LinkedIn, X, Discord, and Slack cards. Inspect Open Graph, Twitter Cards, canonical URL, favicon, image size, and redirects.",
    category: "Utilities",
    seoTitle: "Social Preview & SEO Debugger – Open Graph, Twitter Cards, LinkedIn",
    seoDescription:
      "Free social preview and SEO debugger. See Facebook, LinkedIn, X, Discord, and Slack cards for any URL. Inspect og:title, og:image, Twitter Cards, canonical URL, favicon, image size, redirects, and missing tags.",
    keywords: [
      "open graph",
      "og tags",
      "og:image",
